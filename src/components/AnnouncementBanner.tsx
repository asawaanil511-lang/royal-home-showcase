...
import { Info, AlertTriangle, Trophy, Zap, Megaphone } from "lucide-react";
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        style={{
          background: "linear-gradient(90deg, rgba(30,27,75,0.82) 0%, rgba(30,41,59,0.78) 50%, rgba(30,27,75,0.82) 100%)",
        }}
      >
